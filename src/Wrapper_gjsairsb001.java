...
public class Wrapper_gjsairsb001 implements QunarCrawler {
	...
	public String getSegmentHtml(FlightSearchParam arg0, String sessionId, String flightHtml, boolean returnFlag) {
		...
		try {
			String flightId = returnFlag ? StringUtils.substringBetween(flightHtml,
					"<tableclass=fdff_TFPfdff_TFPbgrdNSid=FT_0_", "cellspacing") : StringUtils.substringBetween(
					flightHtml, "<tableclass=fdff_TFPfdff_TFPbgrdNSid=FT_1_", "cellspacing");
